...
function main() {
  ...
  // Processamento
  const result = femaleBasalMetabolicRate(personWeight, personHeight, personAge)
...
function femaleBasalMetabolicRate(weight, height, age) {
  // https://www.calculator.net/bmr-calculator.html
  const calculus = (10 * weight) + (6.25 * height) - (5 * age) - 161
